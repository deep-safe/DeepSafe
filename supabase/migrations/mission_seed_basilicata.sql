...
('ba510000-0000-0000-0000-000000000001', 'Questa foto della Seed Phrase salvata nel Cloud è sicura?', 'image_true_false', '["Vero", "Falso"]', 1, 'Mai fare foto alle parole! Molte app di galleria fanno backup automatico su Cloud, e l''OCR (riconoscimento testo) le rende ricercabili dagli hacker.', 'https://placehold.co/600x400?text=Seed+Phrase+Photo');
...
('ba510000-0000-0000-0000-000000000002', 'Questa richiesta di firma è pericolosa?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì! Nota "Set Approval For All". Stai dando permesso totale sui tuoi NFT o Token a uno sconosciuto.', 'https://placehold.co/600x400?text=Set+Approval+For+All');
...
('ba510000-0000-0000-0000-000000000003', 'Posso cancellare questo token spam dal mio wallet?', 'image_true_false', '["Vero", "Falso"]', 1, 'No. Non puoi "cancellare" nulla dalla Blockchain. Puoi solo nasconderlo dall''interfaccia o inviarlo a un indirizzo nullo (Burn), ma questo costa Gas e rivela attività.', 'https://placehold.co/600x400?text=Delete+Token+Impossible');
...
('ba510000-0000-0000-0000-000000000004', 'Questo codice è vulnerabile a Reentrancy?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, invia Ether PRIMA di aggiornare il saldo dell''utente. L''attaccante può richiamare la funzione prelievo ricorsivamente prima che il saldo vada a zero.', 'https://placehold.co/600x400?text=Vulnerable+Code+Example');
...
('ba510000-0000-0000-0000-000000000005', 'In questo blocco, vedi un Flash Loan?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, si vede un prestito enorme (es. 10M USDT) che entra e esce nello stesso hash di transazione. Pattern tipico.', 'https://placehold.co/600x400?text=Flash+Loan+Transaction');
...
('ba510000-0000-0000-0000-000000000006', 'Questo grafico del prezzo mostra un Sandwich?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì: Grande acquisto (Bot) -> Tuo acquisto (Vittima a prezzo alto) -> Grande vendita (Bot profitto). Tutto nello stesso istante.', 'https://placehold.co/600x400?text=Sandwich+Attack+Chart');
