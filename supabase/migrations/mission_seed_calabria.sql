...
('ca1ab81a-0000-0000-0000-000000000001', 'Questo hard disk trovato in una discarica contiene file cifrati AES. È a rischio?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì. Se l''attaccante lo conserva per 20 anni, potrà aprirlo. La distruzione fisica è l''unica soluzione per dischi vecchi.', 'https://placehold.co/600x400?text=Encrypted+HDD+Disposal');
...
('ca1ab81a-0000-0000-0000-000000000002', 'Questa suite di cifratura `TLS_RSA_WITH_AES_128_GCM_SHA256` offre PFS?', 'image_true_false', '["Vero", "Falso"]', 1, 'No! Manca "DHE" o "ECDHE". Usa RSA per lo scambio chiavi, quindi se la chiave privata del server viene rubata, tutto il traffico passato è leggibile.', 'https://placehold.co/600x400?text=Cipher+Suite+No+PFS');
...
('ca1ab81a-0000-0000-0000-000000000003', 'Questo roadmap grafico verso il Q-Day è rassicurante?', 'image_true_false', '["Vero", "Falso"]', 1, 'No, mostra che il tempo per migrare (Migration Time) è spesso superiore al tempo che manca all''arrivo della minaccia (Threat Timeline). Siamo in ritardo.', 'https://placehold.co/600x400?text=Q-Day+Timeline+Risk');
...
('ca1ab81a-0000-0000-0000-000000000004', 'Questa formula (Period Finding) è il cuore del pericolo?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, trovare il "periodo" di una funzione modulare è il trucco che permette di fattorizzare i numeri velocemente.', 'https://placehold.co/600x400?text=Shor+Algorithm+Period+Finding');
...
('ca1ab81a-0000-0000-0000-000000000005', 'Questo grafico mostra la complessità di rottura di RSA vs ECC?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì. La linea di ECC è molto più bassa (facile da rompere) per Shor rispetto a RSA a parità di livello di sicurezza classico.', 'https://placehold.co/600x400?text=Shor+Cost+RSA+vs+ECC');
...
('ca1ab81a-0000-0000-0000-000000000006', 'Questo reticolo multidimensionale (Lattice) è il problema difficile?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì. Trovare il "vettore più corto" in un reticolo a 1000 dimensioni è un incubo anche per i quanti.', 'https://placehold.co/600x400?text=Lattice+Grid+Problem');
...
('ca1ab81a-0000-0000-0000-000000000007', 'In questo handshake Wireshark, vedi due ClientHello?', 'image_true_false', '["Vero", "Falso"]', 0, 'No, vedi un solo messaggio ClientKeyExchange che contiene ENTRAMBE le chiavi (Classica + PQC) concatenate.', 'https://placehold.co/600x400?text=Hybrid+Handshake+Packet');
...
('ca1ab81a-0000-0000-0000-000000000008', 'Questo dispositivo rack è un nodo QKD?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, tipico hardware ID Quantique o Toshiba per QKD Enterprise.', 'https://placehold.co/600x400?text=QKD+Hardware+Rack');
...
('ca1ab81a-0000-0000-0000-000000000009', 'Questa mappa della rete QKD europea mostra nodi fidati?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, ogni punto rosso è un luogo fisico dove la chiave "torna in chiaro" per essere rilanciata.', 'https://placehold.co/600x400?text=QKD+Network+Trusted+Nodes');
...
('ca1ab81a-0000-0000-0000-000000000010', 'La Sfera di Bloch rappresenta un Qubit?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, ogni punto sulla superficie della sfera è un possibile stato del Qubit.', 'https://placehold.co/600x400?text=Bloch+Sphere+Qubit');
