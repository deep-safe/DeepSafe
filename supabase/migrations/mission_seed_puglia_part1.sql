...
('ba000100-0000-0000-0000-000000000001', 'Questo log mostra un tentativo di esfiltrazione dati?', 'image_true_false', '["Vero", "Falso"]', 0, 'Una connessione in uscita verso un IP noto di C2 (Command & Control) su porta 443 è un indicatore di compromissione sicuro.', 'https://placehold.co/600x400?text=Firewall+Log+C2+Connection');
...
('ba000100-0000-0000-0000-000000000002', 'Questa ACL (Access Control List) è Stateful?', 'image_true_false', '["Vero", "Falso"]', 1, 'Falso. Le ACL dei router standard sono solitamente Stateless e basate solo su IP sorgente/destinazione.', 'https://placehold.co/600x400?text=Router+ACL+Example');
...
('ba000100-0000-0000-0000-000000000003', 'Questo avviso del browser indica un attacco o un NGFW aziendale?', 'image_true_false', '["Vero", "Falso"]', 1, 'Impossibile distinguerli visivamente. Entrambi sostituiscono il certificato. Ma se sei in azienda, è probabilmente il NGFW mal configurato.', 'https://placehold.co/600x400?text=Untrusted+Certificate+Warning');
...
('ba000100-0000-0000-0000-000000000004', 'Questa regola Snort rileva un attacco SQL Injection?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, cerca pattern testuali come `UNION SELECT` nel traffico HTTP.', 'https://placehold.co/600x400?text=Snort+Rule+Example');
...
('ba000100-0000-0000-0000-000000000005', 'La tecnica "Slowloris" usa la frammentazione?', 'image_true_false', '["Vero", "Falso"]', 1, 'No, usa connessioni incomplete ma valide, non pacchetti IP frammentati.', 'https://placehold.co/600x400?text=Slowloris+Attack');
...
('ba000100-0000-0000-0000-000000000006', 'Questo hash JA3 corrisponde a un malware noto?', 'image_true_false', '["Vero", "Falso"]', 0, 'Gli analisti confrontano gli hash JA3 con database di Threat Intelligence (es. Abuse.ch) per identificare C2 server.', 'https://placehold.co/600x400?text=JA3+Hash+Match');
...
('ba000100-0000-0000-0000-000000000007', 'Questa architettura di rete industriale (Purdue Model) è sicura?', 'image_true_false', '["Vero", "Falso"]', 0, 'Se rispetta la segmentazione (Livelli 0-4) con Firewall/DMZ tra ogni livello, sì. Se è piatta, no.', 'https://placehold.co/600x400?text=Purdue+Model+Architecture');
...
('ba000100-0000-0000-0000-000000000008', 'Questo HMI (pannello di controllo) Windows XP è vulnerabile?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, XP è fuori supporto da anni. È un bersaglio facilissimo per ransomware tipo WannaCry.', 'https://placehold.co/600x400?text=Windows+XP+HMI');
...
('ba000100-0000-0000-0000-000000000009', 'L''approccio "Zero Trust" è applicabile in fabbrica?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, ma è molto difficile per via dei protocolli vecchi che non supportano auth. Si applica via Micro-segmentazione della rete.', 'https://placehold.co/600x400?text=Zero+Trust+OT');
