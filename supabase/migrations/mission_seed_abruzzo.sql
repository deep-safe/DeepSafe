...
('c951060f-5982-66f6-b066-467589345001', 'Questa configurazione è un Backup sicuro?', 'image_true_false', '["Vero", "Falso"]', 0, 'Copiare file in una cartella "Backup" sullo STESSO disco fisico non protegge se il disco si rompe.', 'https://placehold.co/600x400?text=Backup+Folder+On+Same+Drive');
...
('c951060f-5982-66f6-b066-467589345002', 'Questa nota di riscatto è reale?', 'image_true_false', '["Vero", "Falso"]', 1, 'Sembra la classica schermata di WannaCry o LockBit. Il timer serve a creare panico.', 'https://placehold.co/600x400?text=Ransomware+Note');
...
('c951060f-5982-66f6-b066-467589345003', 'Se il backup è su Tape (nastro), è immune ai ransomware online?', 'image_true_false', '["Vero", "Falso"]', 1, 'Vero, una volta espulsa la cassetta, non c''è alcun collegamento elettrico o logico. È l''Air Gap perfetto.', 'https://placehold.co/600x400?text=Tape+Backup');
...
('c951060f-5982-66f6-b066-467589345004', 'In questa foto, l''utente è al sicuro?', 'image_true_false', '["Vero", "Falso"]', 0, 'Lavorare con lo schermo rivolto verso il corridoio o la finestra è un errore grave di opsec.', 'https://placehold.co/600x400?text=Screen+Facing+Window');
...
('c951060f-5982-66f6-b066-467589345005', 'Questo cavo USB sembra normale?', 'image_true_false', '["Vero", "Falso"]', 1, 'Sì, visivamente è identico all''originale. Solo una radiografia mostrerebbe il chip malevolo interno.', 'https://placehold.co/600x400?text=OMG+Cable');
...
('c951060f-5982-66f6-b066-467589345006', 'Questo portafoglio schermato RFID serve davvero?', 'image_true_false', '["Vero", "Falso"]', 1, 'Sì, impedisce ai ladri di leggere le carte contactless passandoti vicino con un POS portatile.', 'https://placehold.co/600x400?text=RFID+Blocking+Wallet');
...
('c951060f-5982-66f6-b066-467589345007', 'Questo dispositivo con le antenne è un router normale?', 'image_true_false', '["Vero", "Falso"]', 0, 'Il Wi-Fi Pineapple è uno strumento specifico per pentesting, riconoscibile dalle molteplici antenne.', 'https://placehold.co/600x400?text=WiFi+Pineapple');
...
('c951060f-5982-66f6-b066-467589345008', 'Se il browser mostra questo avviso rosso, devi cliccare "Avanzate -> Procedi"?', 'image_true_false', '["Vero", "Falso"]', 1, 'Mai in una rete pubblica! Significa che qualcuno sta intercettando la cifratura (Certificato non valido).', 'https://placehold.co/600x400?text=Certificate+Error+Warning');
...
('c951060f-5982-66f6-b066-467589345009', 'È sicuro inserire il numero di carta di credito per pagare 1€ di Wi-Fi Premium qui?', 'image_true_false', '["Vero", "Falso"]', 1, 'Mai su una pagina che appare magicamente. I dati della carta vengono intercettati. Paga alla reception.', 'https://placehold.co/600x400?text=Fake+Payment+Portal');
...
('c951060f-5982-66f6-b066-467589345010', 'Questa icona (Mondo) accanto al file significa che è privato?', 'image_true_false', '["Vero", "Falso"]', 1, 'Il globo significa "Pubblico sul Web". Il lucchetto significa Privato.', 'https://placehold.co/600x400?text=Public+Share+Icon');
...
('c951060f-5982-66f6-b066-467589345011', 'Questa lista di tool "non approvati" rilevati sulla rete è normale?', 'image_true_false', '["Vero", "Falso"]', 0, 'Mostra un alto livello di rischio ombra.', 'https://placehold.co/600x400?text=Shadow+IT+Dashboard');
...
('c951060f-5982-66f6-b066-467589345012', 'Secondo questo grafico, chi è responsabile dei Dati in SaaS?', 'image_true_false', '["Vero", "Falso"]', 1, 'Il modello mostra chiaramente che "Data & Access" è SEMPRE responsabilità del cliente, in ogni modello (IaaS, PaaS, SaaS).', 'https://placehold.co/600x400?text=Shared+Responsibility+Model');
