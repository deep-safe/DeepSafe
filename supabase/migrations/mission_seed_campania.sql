...
('ca000001-e1e1-4c5c-9c9c-000000000001', 'Quali informazioni sensibili possono nascondersi nei metadati di un PDF?', 'multiple_choice', '["Solo il peso del file", "Autore, software usato, data di creazione e cronologia delle revisioni", "Il font usato", "Nessuna"]', 1, 'I metadati sono spesso invisibili a schermo ma leggibili con semplici tool.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000002', 'È possibile fidarsi della ''Data di Creazione'' di un file digitale?', 'multiple_choice', '["Sì, è certificata dal sistema operativo", "No, può essere alterata banalmente (Timestomping) per nascondere lorigine di un malware", "Sì, se il file è di sola lettura", "Solo su Mac"]', 1, 'In informatica forense, i timestamp del filesystem sono considerati dati volatili e non affidabili.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000003', 'Approfondimento su: VEDERE. Qual è il rischio maggiore?', 'multiple_choice', '["Ignoranza", "Mancanza di aggiornamenti", "Password deboli", "Tutte le precedenti"]', 3, 'La sicurezza è un processo, non un prodotto.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000004', 'Perché i dispositivi IoT (lampadine, frigo smart) sono spesso vulnerabili?', 'multiple_choice', '["Costano poco", "Spesso hanno firmware non aggiornabili e password di default hardcoded impossibili da cambiare", "Consumano troppa corrente", "Sono piccoli"]', 1, 'La sicurezza è spesso sacrificata per il basso costo e la facilità d''uso (plug & play).', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000005', 'Se il tuo PC fa parte di una Botnet, te ne accorgi?', 'multiple_choice', '["Sì, compare un teschio", "Spesso no. Il malware lavora silenziosamente in background usando la tua banda per attaccare altri", "Sì, il PC si spegne", "No, perché non esiste"]', 1, 'L''obiettivo della Botnet è restare operativa il più a lungo possibile senza essere scoperta.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000006', 'Un allarme wireless può essere neutralizzato con:', 'multiple_choice', '["Un martello", "Un Jammer radio che satura la frequenza impedendo la comunicazione tra sensori e centralina", "Un telecomando TV", "Una torcia"]', 1, 'Il Jamming crea un ''muro di rumore'' che blocca i segnali radio.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000007', 'Approfondimento su: LOGIN. Qual è il rischio maggiore?', 'multiple_choice', '["Ignoranza", "Mancanza di aggiornamenti", "Password deboli", "Tutte le precedenti"]', 3, 'La sicurezza è un processo, non un prodotto.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000008', 'In un attacco IDN Homograph, un dominio malevolo appare:', 'multiple_choice', '["Scritto in rosso", "Identico alloriginale (es. apple.com) usando caratteri di altri alfabeti visivamente uguali", "Sgranato", "Più lungo"]', 1, 'Sfrutta i limiti dell''occhio umano nel distinguere glifi simili.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000009', 'Scaricare codice da repository pubblici (npm, pip) senza controllo espone a:', 'multiple_choice', '["Nulla", "Typosquatting e Dependency Confusion (scaricare malware con nome simile a librerie lecite)", "Virus nel mouse", "Rallentamenti"]', 1, 'Mai fidarsi ciecamente dei pacchetti pubblici.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000010', 'Approfondimento su: VEDERE. Qual è il rischio maggiore?', 'multiple_choice', '["Ignoranza", "Mancanza di aggiornamenti", "Password deboli", "Tutte le precedenti"]', 3, 'La sicurezza è un processo, non un prodotto.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000011', 'Il DNS over HTTPS (DoH) impedisce al tuo provider internet di:', 'multiple_choice', '["Farti pagare la bolletta", "Vedere quali domini (siti web) stai risolvendo/visitando", "Rallentarti", "Disconnetterti"]', 1, 'Cifra la ''rubrica telefonica'' di internet.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000012', 'Approfondimento su: TRAPPOLA. Qual è il rischio maggiore?', 'multiple_choice', '["Ignoranza", "Mancanza di aggiornamenti", "Password deboli", "Tutte le precedenti"]', 3, 'La sicurezza è un processo, non un prodotto.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000013', 'Approfondimento su: VEDERE. Qual è il rischio maggiore?', 'multiple_choice', '["Ignoranza", "Mancanza di aggiornamenti", "Password deboli", "Tutte le precedenti"]', 3, 'La sicurezza è un processo, non un prodotto.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000014', 'Cosa rende terrificante un exploit ''Zero-Click''?', 'multiple_choice', '["Costa zero euro", "Infetta il dispositivo senza che lutente debba cliccare o fare nulla (basta ricevere un messaggio)", "Non funziona", "Richiede zero secondi"]', 1, 'Sono le armi cibernetiche più sofisticate (es. Pegasus), spesso usate contro target di alto profilo.', NULL);
...
('ca000001-e1e1-4c5c-9c9c-000000000015', 'La truffa BEC (Business Email Compromise) si basa principalmente su:', 'multiple_choice', '["Malware avanzato", "Social Engineering e inganno (fingersi il CEO o un fornitore noto)", "Brute force", "Virus USB"]', 1, 'È hacking psicologico, non tecnologico.', NULL);
