...
('d86f3455-8822-4a0b-9d45-92892976d001', 'Tor Browser protegge la tua identità instradando il traffico:', 'multiple_choice', '["Direttamente al server", "Attraverso tre nodi casuali (Guard, Middle, Exit) cifrati a cipolla", "In incognito", "Via satellite"]', 1, 'Peeling the onion.', NULL);
...
('d86f3455-8822-4a0b-9d45-92892976d002', 'In ambito Chi sta parlando? (Cybersecurity), qual è la regola d''oro?', 'multiple_choice', '["Fidarsi di tutti", "Zero Trust (Mai fidarsi, verificare sempre)", "Usare password 123456", "Non usare il computer"]', 1, 'La fiducia implicita è la vulnerabilità principale.', NULL);
...
('d86f3455-8822-4a0b-9d45-92892976d003', 'In ambito Il Contesto è Re (Cybersecurity), qual è la regola d''oro?', 'multiple_choice', '["Fidarsi di tutti", "Zero Trust (Mai fidarsi, verificare sempre)", "Usare password 123456", "Non usare il computer"]', 1, 'La fiducia implicita è la vulnerabilità principale.', NULL);
