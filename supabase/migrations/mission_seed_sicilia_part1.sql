...
('51c11a01-0000-0000-0000-000000000001', 'Questa icona (Cipolla verde) indica sicurezza totale?', 'image_true_false', '["Vero", "Falso"]', 1, 'Indica solo che Tor è attivo. Se fai login su Facebook HTTP, le password viaggiano in chiaro dall''Exit Node.', 'https://placehold.co/600x400?text=Tor+Circuit+Active');
...
('51c11a01-0000-0000-0000-000000000002', 'Questo avviso "Verifica identità" in Tor è normale?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, molti siti (Cloudflare) bloccano o sfidano gli IP Tor perché spesso usati da bot.', 'https://placehold.co/600x400?text=Tor+Captcha+Loop');
...
('51c11a01-0000-0000-0000-000000000003', 'Questo indirizzo onion è valido?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, formato v3 standard (lungo, finisce con d, e 56 char).', 'https://placehold.co/600x400?text=v3+Onion+Address');
...
('51c11a01-0000-0000-0000-000000000004', 'Questa transazione è bloccata in Escrow?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, lo stato mostra "Escrowed". I fondi sono congelati in attesa di Finalize.', 'https://placehold.co/600x400?text=Escrow+Status');
...
('51c11a01-0000-0000-0000-000000000005', 'Questo grafico reputazione venditore è sospetto?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, un picco verticale di recensioni positive tutte uguali in 24h indica "Padding" (recensioni false).', 'https://placehold.co/600x400?text=Fake+Review+Padding');
...
('51c11a01-0000-0000-0000-000000000006', 'Questo puzzle rotante serve a bloccare i DDoS?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, costringe ogni richiesta a spendere "lavoro umano" (Proof of Work), rallentando gli attacchi.', 'https://placehold.co/600x400?text=Hard+Clock+Captcha');
...
('51c11a01-0000-0000-0000-000000000007', 'Questa transazione con 50 input e 50 output uguali è un CoinJoin?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, pattern tipico visivamente riconoscibile sulla Blockchain.', 'https://placehold.co/600x400?text=CoinJoin+Pattern');
...
('51c11a01-0000-0000-0000-000000000008', 'Posso vedere quanti XMR ha questo indirizzo pubblico?', 'image_true_false', '["Vero", "Falso"]', 1, 'No. Il saldo è crittografato sulla blockchain. Solo il proprietario lo sa.', 'https://placehold.co/600x400?text=Monero+Balance+Hidden');
...
('51c11a01-0000-0000-0000-000000000009', 'Questo grafo mostra un flusso di riciclaggio?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, la dispersione dei fondi in centinaia di wallet (fan-out) e il raggruppamento finale (fan-in) è tipico.', 'https://placehold.co/600x400?text=Chainalysis+Graph');
...
('51c11a01-0000-0000-0000-000000000010', 'Questo blocco di testo `-----BEGIN PGP MESSAGE-----` è sicuro?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, è il formato ASCII Armor standard per i messaggi cifrati.', 'https://placehold.co/600x400?text=PGP+Message+Block');
...
('51c11a01-0000-0000-0000-000000000011', 'Questa schermata chiede di decifrare per entrare?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, tipico challenge PGP 2FA. Senza decifrare quel blocco, non passi.', 'https://placehold.co/600x400?text=PGP+2FA+Challenge');
...
('51c11a01-0000-0000-0000-000000000012', 'Questi due grafici di traffico (Entrata vs Uscita) matchano?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, la forma dell''onda è identica, solo traslata di pochi millisecondi. Correlazione confermata.', 'https://placehold.co/600x400?text=Traffic+Logs+Match');
...
('51c11a01-0000-0000-0000-000000000013', 'Questo sito dice "Your Browser is Unique". È un bene?', 'image_true_false', '["Vero", "Falso"]', 1, 'Male. Vogliamo essere "Common" (comuni), non unici. L''unicità è la morte dell''anonimato.', 'https://placehold.co/600x400?text=Browser+Uniqueness+Test');
...
('51c11a01-0000-0000-0000-000000000014', 'Il livello di sicurezza è impostato su "Standard". Sei a rischio?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, Standard abilita JS e media audio/video ovunque. Superficie d''attacco massima.', 'https://placehold.co/600x400?text=Security+Level+Standard');
