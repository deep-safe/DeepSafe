...
('51c11a01-0000-0000-0000-000000000015', 'Questa console di router I2P indica che sei connesso?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, "Active: OK" e tunnel verdi indicano partecipazione alla rete.', 'https://placehold.co/600x400?text=I2P+Router+Console');
...
('51c11a01-0000-0000-0000-000000000016', 'Questa chiave CHK@ permette di scaricare un file?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, Content Hash Key è l''indirizzo univoco del contenuto in Freenet.', 'https://placehold.co/600x400?text=Freenet+CHK+Key');
...
('51c11a01-0000-0000-0000-000000000017', 'Questo indirizzo 1HeLLo4uzja... è un sito ZeroNet?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, è un indirizzo Bitcoin valido usato come identificativo del sito.', 'https://placehold.co/600x400?text=ZeroNet+Site+Address');
...
('51c11a01-0000-0000-0000-000000000018', 'Questa schermata di benvenuto richiede una password?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, la password di amministrazione (facoltativa) o quella del volume persistente encrypted.', 'https://placehold.co/600x400?text=Tails+Welcome+Screen');
...
('51c11a01-0000-0000-0000-000000000019', 'Questi dati EXIF mostrano una latitudine/longitudine?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, coordinate GPS chiare. Errore fatale.', 'https://placehold.co/600x400?text=EXIF+GPS+Data');
...
('51c11a01-0000-0000-0000-000000000020', 'Questo post forum che cita "fuso orario CET" è un leak?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, rivela che l''utente si trova in Europa Centrale. Info preziosa.', 'https://placehold.co/600x400?text=Timezone+Leak');
...
('51c11a01-0000-0000-0000-000000000021', 'Questo pannello di controllo serve a gestire infezioni?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, dashboard tipica di un affiliato RaaS con statistiche e chat vittime.', 'https://placehold.co/600x400?text=RaaS+Dashboard');
...
('51c11a01-0000-0000-0000-000000000022', 'Questa info trapelata (Bolletta Luce) aiuta il doxxing?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, conferma nome + indirizzo in modo inequivocabile (Utility Bill).', 'https://placehold.co/600x400?text=Utility+Bill+Leak');
...
('51c11a01-0000-0000-0000-000000000023', 'Questo annuncio "VPN Access - Revenue $500M" è di un IAB?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, tipico annuncio di vendita accesso. Non nomina l''azienda ma il fatturato.', 'https://placehold.co/600x400?text=IAB+Sale+Listing');
...
('51c11a01-0000-0000-0000-000000000024', 'Questa pagina di sequestro FBI/Europol è vera?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, la "Seizure Banner" è il trofeo finale dell''operazione.', 'https://placehold.co/600x400?text=This+Domain+Seized');
...
('51c11a01-0000-0000-0000-000000000025', 'Questo server sequestrato è un "Cold Boot attack"?', 'image_true_false', '["Vero", "Falso"]', 0, 'No, Cold Boot implica congelare la RAM con spray. Questo è un semplice sequestro hardware.', 'https://placehold.co/600x400?text=Server+Rack+Seizure');
...
('51c11a01-0000-0000-0000-000000000026', 'Questo codice assembly è uno shellcode di exploit?', 'image_true_false', '["Vero", "Falso"]', 0, 'Sì, istruzioni di basso livello per prendere il controllo della CPU dopo un buffer overflow.', 'https://placehold.co/600x400?text=Shellcode+Exploit');
